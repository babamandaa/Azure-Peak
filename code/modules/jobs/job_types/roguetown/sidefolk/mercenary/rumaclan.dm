/datum/advclass/mercenary/rumaclan
	...
	traits_applied = list(TRAIT_NOPAINSTUN, TRAIT_HONORBOUND, TRAIT_BLOOD_RESISTANCE) //lose critres and hard dismember like everyone else, get blood resistance in return
